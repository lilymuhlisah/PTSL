            ...
            <div class="x_panel mt-2">
                <div class="x_content">
                    <form class="" action="" method="post" novalidate style="font-size: 14px !important">
                        ...
                        <div class="field item form-group">
                            <label for="nip" class="col-form-label col-md-3 col-sm-3  label-align">Nomor Induk Pegawai (NIP)<span style="color:red">*</span></label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" type="text" id="nip" name="nip" value="<?= set_value('nip'); ?>">
                                <?= form_error('nip', '<small class="form-text text-danger text-left">', '</small>'); ?>
                            </div>
                        </div>
