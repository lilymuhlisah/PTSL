                    ...
                    <div class="nav navbar-right panel_toolbox">
                        <div class="title_right">
                            <div class="col-md-12 col-sm-12 mt-2">
                                <a href="<?= base_url(); ?>admin/add_userdesa" role="button" style="float: right; height: 15%; width: 100%; color:darkcyan; font-size:14px"><i class="fa fa-plus"></i><strong> Tambah Data Pengguna</strong></a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    foreach ($u_pengguna as $user) : ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?= $user['username']; ?></td>
                                                <td><?= $user['email']; ?></td>
                                                <td><a href="<?= base_url(); ?>admin/detail_userdesa/<?= $user['id_pengguna']; ?>" class="btn btn-info btn-sm">Lihat Detail</a></td>
