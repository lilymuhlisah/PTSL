                ...
                <div class="x_content">
                    ...
                    <div class="field item form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <a href="<?= base_url(); ?>admin/edit_userkantah/<?= $u_pengguna['id_pengguna']; ?>" class="btn btn-success btn-sm" style="float: right; margin-right:5%;"><i class="fa fa-pencil-square-o"></i> Edit </a>
                        </div>
                    </div>

                    <div class=" field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3" style="margin-left: 20px !important">Nomor Induk Pegawai (Pegawai)</label>
                        <div class="col-form-label col-md-6 col-sm-6">
                            <strong><?= $u_pengguna['nip']; ?></strong>
                        </div>
                    </div>
