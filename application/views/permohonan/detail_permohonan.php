                    ...
                    <div class="x_content">
                        ...
                        <form style="font-size: 14px !important">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-sm-3">
                                    <a href="<?= base_url(); ?>Panitiadesa/delete_permohonan/<?= $permohonan['id_permohonan']; ?>" class="btn btn-danger btn-sm" style="float: right; margin-right:5%;" onclick="return confirm('Apakah Anda yakin ingin menghapus data?');"><i class="fa fa-trash"></i> Hapus </a>
                                    <a href="<?= base_url(); ?>Panitiadesa/edit_permohonan/<?= $permohonan['id_pemohon']; ?>/<?= $permohonan['id_permohonan']; ?>" class="btn btn-success btn-sm" style="float: right; margin-right:5%;"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-form-label col-md-6 col-sm-6">
                                    <strong><?= $permohonan['nama_kegiatan'] ?></strong>
                                </div>
                            </div>
