        ...
        <div class="col-md-12 col-sm-12 mt-3">
            <div class="x_panel">
                ...
                <div class="row float-right">
                    <div class="col-md-12">
                        <form action="<?= base_url('panitiadesa/') . 'berkas_onprocess'; ?>" method="get">
                                    ...
                                    <?php foreach ($permohonan as $pmh) : ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url(); ?>panitiadesa/detail_permohonan/<?= $pmh['id_pemohon']; ?>/<?= $pmh['id_permohonan']; ?>" class="btn btn-success btn-sm" style="float: right;">Lihat detail</a></td>
